...
#define RED_PWM_OUT_N_INVERT               (0lu)
#define RED_PWM_OUT_INVERT                 (0lu)
...
/* Interrupt Mask */
#define RED_PWM_INTERRUPT_MASK             (0lu)
